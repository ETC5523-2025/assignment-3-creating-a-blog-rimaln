...
The three streams studied vary in climate and land use Table @ref(tab:sites_summary), which allows us to test whether a common modelling framework can capture nitrate variation across different conditions.
